...
class _HomeState extends State<Home> {
  ...
  //   super.initState();
  //   getAllListings();
  //   //this is ex code to add a doc id after creation
  //   aListing.docId = '0ggZKemWVFZV5CrujRJq';
  //   allListings.add(aListing);
  //   print('this is ${aListing.docId}');
  // }

  // Listings aListing = Listings(
  //     docId: '',
  //     datePosted: '2023-02-12',
  //     description:
  //         'A lightly used Wilson basketball -- use on any of the on-campus courts!',
  //     imgUrl:
  //         'https://firebasestorage.googleapis.com/v0/b/zot-list.appspot.com/o/images%2F0ggZKemWVFZV5CrujRJq.png?alt=media&token=3841e906-08dd-48b8-8683-b3c1a0e136e0',
  //     isAcceptable: false,
  //     isAthletics: true,
  //     isClothing: false,
  //     isElectronics: false,
  ...
  //   Listings(
  //     docId: '1GXUCfu9trXFUYTmnpIK',
  //     datePosted: '2023-02-15',
  //     description: 'Fleece tan sweater -- super cozy!',
  //     imgUrl:
  //         'https://firebasestorage.googleapis.com/v0/b/zot-list.appspot.com/o/images%2F1GXUCfu9trXFUYTmnpIK.png?alt=media&token=f45b6864-ad5e-4f12-b335-ae50289c6a99',
  //     isAcceptable: false,
  //     isAthletics: false,
  //     isClothing: true,
  //     isElectronics: false,
